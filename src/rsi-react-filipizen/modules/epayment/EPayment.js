...
import { Service } from "../verification/node_modules/rsi-react-web-components";
...
const EPayment = (props) => {
  ...
  const createPaymentOrder = (payee) => {
    ...
    const createPo = async () => {
      ...
      let svc = Service.lookupAsync(
        `${partner.id}:EPaymentService`,
        "epayment"
      );
  ...
  const pages = [
    {
      ...
      actions: { onCancel: goBack, onVerify: updateContact },
    },
    {
      name: "billing",
      title: module.title,
      component: module.component,
      actions: { onCancel: onCancelBilling, onSubmit: checkoutOrder },
    },
    {
      name: "verification",
      ...
      actions: {
        movePrevStep: onCancelEmailVerification,
        moveNextStep: gotoCheckout,
      },
    },
    {
      name: "checkout",
      ...
      actions: { onCancel: onCancelCheckout, onSubmit: createPaymentOrder },
    },
    {
      name: "payment",
      title: "Online Payment",
      component: OnlinePayment,
      actions: { onCancel: movePrevious, onSubmit: () => {} },
    },
  ];
